...
const preambleCode = `
// taken from: https://github.com/open-wc/open-wc/blob/master/packages/dev-server-hmr/src/wcHmrRuntime.js
 ...
 */
export function register(key, clazz) {
...
window.customElements.define = (tagName, classObj, ...rest) => {
  register(tagName, classObj);

  if (!window.customElements.get(tagName)) {
    originalDefine.call(window.customElements, tagName, classObj, ...rest);
  }
};
`;
